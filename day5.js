...
console.log(`Square of a number is: ${squareOfNumber(4)}`);
...
let Name = "Lucky";
let lastNameConcat = Name.concat("Kashyap");
console.log(
  `Full Name by using of concat expression function: ${lastNameConcat}`
);
...
console.log(
  `Check that string has a specific char (true / false) : ${hasSpecificChar(
    "Anshu",
    "s"
  )}`
);
...
console.log(
  "Higher order function to pass two func, value and time to run n times: ",
